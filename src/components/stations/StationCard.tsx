...
const statusStyles = {
  ...
  attente_da: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  attente_djc: 'bg-purple-100 text-purple-700 border-purple-200',
  attente_dsi: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  validation_juridique: 'bg-emerald-100 text-emerald-700 border-emerald-200',
