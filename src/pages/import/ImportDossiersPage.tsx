...
export default function ImportDossiersPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'attente_paiement': 
        return <Badge className="bg-blue-100 text-blue-700 border-blue-200 uppercase text-[9px] font-black underline decoration-wavy">3. Prêt pour Transport</Badge>;
      case 'en_transport': 
  ...
  const handleAction = (dossier: ImportDossier) => {
    ...
    if (statut === 'en_preparation' && isRole(['directeur_importation', 'agent_suivi_cargaison', 'directeur_logistique', 'responsable_depots', 'operateur_logistique'])) {
    ...
    // 3. Logistique confirms transport/departure
    if (statut === 'attente_paiement' && isRole(['directeur_importation', 'agent_suivi_cargaison', 'directeur_logistique'])) {
       updateStatusMutation.mutate({ id, status: 'en_transport' });
       return;
    }
          ...
          <Card className="glass-card">
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">En Attente Flux</p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white/50 backdrop-blur-md p-4 rounded-3xl border border-white">
          ...
          <Dialog>
            <DialogTrigger asChild>
              {isRole(['directeur_importation', 'agent_suivi_cargaison', 'directeur_logistique', 'responsable_depots']) && (
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                if (d.statut === 'en_preparation' && isRole(['directeur_importation', 'agent_suivi_cargaison', 'directeur_logistique', 'responsable_depots'])) {
                ...
                } else if (d.statut === 'attente_paiement' && isRole(['directeur_importation', 'agent_suivi_cargaison', 'directeur_logistique'])) {
                  actionBtnLabel = "Lancer le Transport";
                  actionBtnIcon = <Ship className="h-4 w-4" />;
                  actionBtnVariant = "default";
